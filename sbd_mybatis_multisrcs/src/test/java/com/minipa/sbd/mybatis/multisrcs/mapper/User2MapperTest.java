package com.minipa.sbd.mybatis.multisrcs.mapper;
...
public class User2MapperTest {
	...
	public void testInsert() throws Exception {
		userMapper.insert(new User("aa", "a123456", SexEnum.MAN));
		userMapper.insert(new User("bb", "b123456", SexEnum.WOMAN));
		userMapper.insert(new User("cc", "b123456", SexEnum.WOMAN));
